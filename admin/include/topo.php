  <div class="cont flex img mb-7">
    ...
    <ul class="menu x-xl invisible md:visible">
        <li><a href="<?php echo BASE_ADMIN;?>total_turmas.php" class="bg-marista2 text-white px-6 py-2 rounded-lg drop-shadow-lg mt-6">Total por Turmas</a></li>
      <li><a href="<?php echo BASE_ADMIN;?>relatorio.php" class="bg-marista2 text-white px-6 py-2 rounded-lg drop-shadow-lg mt-6">Relatorio Alunos</a></li>
      <?php if(in_array($_SESSION['login']['permissao'], ['admin'])){ ?>
      <li><a href="<?php echo BASE_ADMIN;?>#" class="bg-marista2 text-white px-6 py-2 rounded-lg drop-shadow-lg mt-6">Adicionar Aluno</a></li>
      <?php } ?>
